...
<div class="responsive-container-block bigContainer">
    <div class="responsive-container-block Container">
        <div class="imgContainer">
            ...
            <img class="mainImg" src="img/aboutdot.svg">
        </div>
        <div class="responsive-container-block textSide">
            ...
            <p class="text-blk subHeading">
                Since its founding in 2021, TRUSTlab Diagnostics is committed to revolutionizing the healthcare industry
                through precision diagnostics and compassionate care. Founded on the principles of accuracy,
                reliability, and patient-centric service, we strive to deliver excellence in every test we conduct.
            </p>

            <p class="text-blk subHeading">
                TRUSTlab has worked relentlessly towards achieving greater standards of testing capabilities, adding to
                its ever-growing test-menu in conjunction with cutting-edge technologies, qualified & skilled
                professionals, customized processes of optimization.
            </p>


            <p class="text-blk subHeading">
                We have increased our footprint from a single lab in Hyderabad to over 20 labs across India, each
                equipped with State-of-the-Art diagnostic equipment, to make avilable world-class testing outcomes to
                more and more people Pan India.
            </p>

            <p class="text-blk subHeading">
                We continue to live up to our responsibilities, following the most ethical practices and take great
                pride in our quality of service. Whether you are a medical professional, a patient or someone just
                seeking to stay healthy – TRUSTlab is always there where you need us: close at hand!
            </p>
...
<div style="text-align: center; padding-bottom: 5%;" class="image-container">
    <img src="img/core-values.png" width="10%" style="padding: 20px;" />
