...
<div class="management-section">
    ...
    <div class="cards-container">
        ...
        <div class="management-card">
            <img src="img/dr_rajah.png" alt="Director 1" class="director-image">
        ...
        <!-- Second Card -->
        <div class="management-card">
            <img src="https://www.mytrustlab.com/img/management/vinitha.jpg" alt="Director 2" class="director-image">
...
<div class="modal" id="modalrajah">
    <div class="modal-content">
        ...
        <div class="modal-left">
            <img src="img/dr_rajah.png" alt="Director 1" class="modal-director-image">
            <h3>Dr. Rajah V Koppala</h3>
            <p>Interventional Radiologist</p>
            <hr>
        </div>
        <div class="modal-right">
            <p style="margin-bottom: 25px;">Dr. Rajah V Koppala is a Vascular Surgeon,Interventional Radiologist and
                Radiologist in Jubilee Hills, Hyderabad and has an experience of 29 years in these fields. Dr. Rajah V
                Koppala practices at Avis Hospitals in Jubilee Hills, Hyderabad and Apollo Spectra Hospital in Alwarpet,
                Chennai. He completed MBBS from Osmania Medical College, Hyderabad in 1995,MD - Vascular Interventional
                Radiology from ENGLAND in 1998 and MD - Radio Diagnosis/Radiology from ENGLAND in 1998.</p>
            <p style="margin-bottom: 25px;">He is a member of Radiological Society of North America,Royal College Of
                Radiologists-UK,British Society of Interventional Radiology. and Singapore Radiological Society. Some of
                the services provided by the doctor are: Bleeding Internally,Vena Cava Filter,Diagnostic Cardiovascular
                Imaging,Pediatrics and Stent Graft </p>
        </div>
    </div>
</div>
...
<div class="modal" id="modal2">
    <div class="modal-content">
        ...
        <div class="modal-left">
            <img src="https://www.mytrustlab.com/img/management/vinitha.jpg" alt="Director 2"
        ...
        <div class="modal-right">
            <p style="margin-bottom: 25px;">Dr. Vinitha holds a Ph.D. in Chemical Engineering, with a specialization in
                the computational modeling of air quality and Geographic Information Systems (GIS). Her extensive
                research has focused on developing metrics to assess population exposure to ozone, addressing critical
                environmental and public health challenges.</p>

            <p style="margin-bottom: 25px;">
                As the head of the Business Relations at Trustlab, Dr. Vinitha plays a pivotal role in shaping the
                organization's initiatives, ensuring that data-driven strategies align with the company’s vision for
                sustainable growth and innovation in health diagnostics. Her leadership not only enhances Trustlab's
